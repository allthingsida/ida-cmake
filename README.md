...
>*`ida-cmake` has been tested with IDA SDK 7.2 and works up to IDA SDK 8.4.* For IDA 8.5 and above, please check the main branch.*
...
```batch
mklink /j c:\idasdk84\ida-cmake c:\projects\ida-cmake
